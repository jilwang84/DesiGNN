...
class DescriptionCombiner:
    ...
    def combine_descriptions(self):
        ...
        # Formulate a question for the LLM
        #combined_description += "\nBased on the dataset name, type, user description, k-hop subgraph analysis, " \
        #                        "and the above metrics, which benchmark dataset(s) should this unseen dataset be " \
        #                        "compared to in order to adopt a suitable AutoGNN configuration for initializing " \
        #                        "the process? Please provide reasons for your recommendation."
